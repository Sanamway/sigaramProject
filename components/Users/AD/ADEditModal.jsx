...
const ADEditModal = ({
  ...
  useEffect(() => {
    ...
    const skill = selectedIndustry.industries
    const email = selectedIndustry.email
    const mobile = selectedIndustry.mobile
    setName(name)
    setSkills(
      skill?.map((s) => {
  ...
  return (
    ...
    >
      <Modal.Body className={styles.modalBodyDesktop}>
        ...
        <h3 className={styles.modalHeadingMain}>Edit a new AirTeams AD</h3>
