...
const IndustryDeleteModal = ({
  ...
  const submitHandler = (e) => {
    ...
    axios({
      method: 'DELETE',
      url: `/industries/${selectedIndustry._id}`,
    })
      .then((res) => {
        handleClose()
        getAllIndusries()
  ...
  return (
    ...
    >
      <Modal.Body className={styles.modalBodyDesktop}>
        ...
        <h3 className={styles.modalHeadingMain}>Delete Industry</h3>
        <p className={styles.modalParaMain}>
          Delete an industry category for it to not be visible at the front end.
        </p>
...
export default IndustryDeleteModal
