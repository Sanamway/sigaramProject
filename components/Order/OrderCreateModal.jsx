...
const OrderCreateModal = ({ show, handleClose, getAllIndusries }) => {
  ...
  return (
    ...
    >
      <Modal.Body className={styles.modalBodyDesktop}>
        ...
        <h3 className={styles.modalHeadingMain}>Add New Order</h3>
        <p className={styles.modalParaMain}>
          Enter a new order set for it to be visible at the front end.
        </p>
